...
In this series, there are two files for each step in the tutorial. One is called `###_Title.nb.html`, and it's a plain HTML file you can open. In that file, you will see plain text, as well as boxes of code. The grey boxes have code you can copy-paste into an R script, or line-by-line at the R console. The white boxes below show the output you should see after running each chunk. They look like this:
