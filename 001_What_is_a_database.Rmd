...
In general, databases are for storage and organization, and you use other tools like R or SAS for analysis, so you could run a SQL command to join those two tables:
